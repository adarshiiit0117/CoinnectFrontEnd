...
value={amount}
className="withdrawalInput py-7 border-none ouline-none focus:outline-none px-0 text-2xl text-center "
placeholder="$9999"
type="number"
/>
</div>
...
<p className="text-xs">********5671</p>
 </div>
        </div>

    
</div>
<DialogClose><Button  onClick={handleSubmit} className="w-full py-7 text-xl">Withdraw</Button></DialogClose>
